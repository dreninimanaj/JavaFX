...
//            LoanCalculatorService.buildTable(loan, SessionMenager.getClient().getClientId());
//
...
////            payments.addAll(LoanCalculatorService.buildTable(loan,SessionMenager.getClient().getClientId()));
//            table.setItems(payments);
//
//
//        } catch (Exception e) {
